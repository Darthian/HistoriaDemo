...
public class AntecedentesQuirurgicosMB {
	...
	private List<Antecedentes_Quirurgicos> listaAntHC;
...
//	public void consolidarAntecedenteQuirurgico(){
//		try{
//			System.out.println("++++++++++++++++++++++ ENTRA AL METODO DE CONSOLIDAR ANTECEDENTES Quirurgico" );
...
//	}
	...
	public void consolidarAntecedenteQuirurgico(long idConsulta){
		try{
			System.out.println("++++++++++++++++++++++ ENTRA AL METODO DE CONSOLIDAR ANTECEDENTES Quirurgico" );
			List<Antecedentes_Quirurgicos> listobjetoConsolidado = antDAO.BuscarNoConsolidados();
			if(listobjetoConsolidado!= null && listobjetoConsolidado.size() > 0){
				for(Antecedentes_Quirurgicos iterator : listobjetoConsolidado){
	...
	public List<Antecedentes_Quirurgicos> getListaAntHC() {
		return listaAntHC;
	}

	public void setListaAntHC(List<Antecedentes_Quirurgicos> listaAntHC) {
