...
//	public void consolidarAntecedenteFamiliar(){
//		try{
...
//	}
	...
	public void consolidarAntecedenteFamiliar(long idConsulta){
		try{
			System.out.println("++++++++++++++++++++++ ENTRA AL METODO DE CONSOLIDAR ANTECEDENTES FAMILIARES" );
			List<Antecedentes_Familiares> listobjetoConsolidado = antDAO.BuscarNoConsolidados();
			if(listobjetoConsolidado!= null && listobjetoConsolidado.size() > 0){
				for(Antecedentes_Familiares iterator : listobjetoConsolidado){
